...
test('test overview example', () => {
    ...
    let errors = [
        createError("", INVALID_VALUE_ERROR, myTweet2),
    ];
    validateErrors(tweetSchema, myTweet2, errors);

    errors = [
        createError("", INVALID_VALUE_ERROR, myTweet3),
    ];
...
test("test 'Validating a single value' example", () => {
    ...
    let errors = [
        createError("", INVALID_VALUE_ERROR, "hello world", int.$name),
    ];
...
test("test 'Validating an object with constant properties' example", () => {
    ...
    let errors = [
        createError("wheels", INVALID_VALUE_ERROR, 5),
    ];
...
test("test 'Creating a custom type' example", () => {
    ...
    let errors = [
        createError("a", INVALID_VALUE_ERROR, 20, primeNumber.$name),
    ];
...
test("test typeWithInstanceOf usage", () => {
    ...
    let errors = [
        createError("", INVALID_VALUE_ERROR, data2, "Apple"),
    ];
...
test("test $test example #1", () => {
    ...
    let errors = [
        createError("country", INVALID_VALUE_ERROR, "Brazil"),
    ];
