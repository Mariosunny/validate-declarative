...
testTypeWith
    ...
    .invalidValues(standardValuesExcept("int").concat([Number.MIN_VALUE, 0, 1, Number.MAX_VALUE, Number.MAX_SAFE_INTEGER]));
...
testTypeWith
    ...
    .validValues([
        ...
        new Array([]),
        new Array([[[[[[[[[]]]]]]]]]),
    ].concat(_.values(standardValues).concat({a: 5}).map(function(value) {
...
testTypeWith
    ...
    .invalidValues(standardValuesExcept("date").concat([
        Date,
        Date(),
        Date.now(),
...
testTypeWith
    ...
    .invalidValues(standardValuesExcept("symbol").concat([
        Object(Symbol())
    ]));
